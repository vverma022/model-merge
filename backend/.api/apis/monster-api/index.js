...
class SDK {
     ...
     */
    postGenerateDataAugmentationService(body, metadata) {
     ...
     */
    postGenerateImg2img(body, metadata) {
     ...
     */
    postGeneratePhotoMaker(body, metadata) {
     ...
     */
    postGeneratePix2pix(body, metadata) {
     ...
     */
    postGenerateSdxlBase(body, metadata) {
     ...
     */
    postGenerateSpeech2textV2(body, metadata) {
     ...
     */
    postGenerateSunoaiBark(body, metadata) {
     ...
     */
    postGenerateTxt2img(body, metadata) {
     ...
     */
    postGenerateWhisper(body, metadata) {
